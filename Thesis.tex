...
\input{Chapters/1 - Intro/Main}
\input{Chapters/2 - OpenData/Main}
\input{Chapters/3 - Technologies/Main}
\input{Chapters/4 - Stories/Main}
\input{Chapters/5 - Architecture/Main}
\input{Chapters/6 - Manual/Main}
\input{Chapters/7 - Conclusion/Main}
